export const swaggerCustomJs = (baseUrl: string, logoUrl: string) => `
(function () { 
...
export const swaggerCustomCss = `
    ...
    background: #3f9f42;
    /* Old browsers  */
    background: -moz-linear-gradient(left, #3f9f42 0%, #bb5f0e 41%);
    /* FF3.6+ */
    background: -webkit-linear-gradient(left, #3f9f42 0%, #bb5f0e 41%);
    /* Chrome10+,Safari5.1+ */
    background: -o-linear-gradient(left, #3f9f42 0%, #bb5f0e 41%);
    /* Opera 11.10+ */
    background: -ms-linear-gradient(left, #3f9f42 0%, #bb5f0e 41%);
    /* IE10+ */
    background: linear-gradient(to right, #3f9f42 0%, #bb5f0e 41%);
    /* W3C */
...
@media only screen and (prefers-color-scheme: dark) {
    ...
    .swagger-ui .opblock.opblock-post .opblock-summary-method, .swagger-ui .opblock.opblock-post .tab-header .tab-item.active h4 span::after { background: #329356; }

    .swagger-ui .opblock.opblock-post .opblock-summary { border-color: #329356; }
    ...
    .swagger-ui .opblock.opblock-delete .opblock-summary-method, .swagger-ui .opblock.opblock-delete .tab-header .tab-item.active h4 span::after { background: #af2323; }
    ...
    .swagger-ui .opblock.opblock-patch .opblock-summary-method, .swagger-ui .opblock.opblock-patch .tab-header .tab-item.active h4 span::after { background: #3ba540; }
